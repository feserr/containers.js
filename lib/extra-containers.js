...
function binarySearch(container, value) {
  ...
  return startIndex; // console.log('Target value not found in array');
} // function binarySearch(container, value) {
//   const size = container.length;
//   if (value >= container[size - 1]) return size - 1;
//   if (value < container[0]) return -1;
//   let pivot = size >> 1;
//   let end = pivot + 1 >> 1;
//   let iterations = size;
//   while (iterations-- > 0) {
...
//       pivot -= end;
//     } else {
//       if (container[pivot + 1] > value || pivot >= size - 1) {
//         return pivot;
//       }
//       pivot += end;
//     }
...
/*!**********************!*\
  ...
  \**********************/
/*! namespace exports */
/*! export List [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/list.js .default */
/*! export SortedArray [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/sorted_array.js .default */
