...
var SortedArray = /*#__PURE__*/function () {
  ...
  _createClass(SortedArray, [{
    ...
    value: function isValidPosition(position) {
      if (!(0,underscore__WEBPACK_IMPORTED_MODULE_1__.isNumber)(position) || !Number.isInteger(position)) {
    ...
    value: function push(data) {
      if ((0,underscore__WEBPACK_IMPORTED_MODULE_1__.isObject)(data)) {
        throw new TypeError('SortedArray is only compatible with Numbers and Strings');
      }
    ...
    value: function remove(position) {
      ...
      var dataElement = this.arrayData[position];
